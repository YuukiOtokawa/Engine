...
void MeshRenderer::Render() {
	...
	// シャドウマップをピクセルシェーダーのt1レジスタにバインド
	auto shadowMap = MainEngine::GetInstance()->GetRenderCore()->GetDepthStencil();
	MainEngine::GetInstance()->GetRenderCore()->GetDeviceContext()->PSSetShaderResources(1, 1, &shadowMap);
